...
export default function MovieCard({ imgSrc, movieTitle, movieReleaseDate, movieOverview }) {
  const _imgSrcBase = 'https://image.tmdb.org/t/p/original/';
  const _noPosterUrl = 'https://www.kino-teatr.ru/static/images/no_poster.jpg';
  const releaseDate =
